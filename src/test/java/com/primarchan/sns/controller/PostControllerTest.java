...
class PostControllerTest {
    ...
    @Test
    @WithAnonymousUser
    void 포스트_작성시_로그인을_하지않은_경우() throws Exception {
        String title = "title";
        String body = "body";
    ...
    @Test
    @WithMockUser
    void 포스트_수정시_수정하려는_글이_없는_경우_에러발생() throws Exception {
        String title = "title";
        String body = "body";
    ...
    @Test
    @WithAnonymousUser
    void 내_피드목록_요청시_로그인하지_않은_경우() throws Exception {
        when(postService.my(any(), any())).thenReturn(Page.empty());
    ...
    @Test
    @WithAnonymousUser
    void 좋아요_버튼_클릭시_로그인하지않은_경우() throws Exception {
    ...
    @Test
    @WithMockUser
    void 좋아요_버튼_클릭시_게시물이_존재하지않는_경우() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void 댓글_작성시_로그인하지않은_경우() throws Exception {
    ...
    @Test
    @WithMockUser
    void 댓글_작성시_게시물이_존재하지않는_경우() throws Exception {
